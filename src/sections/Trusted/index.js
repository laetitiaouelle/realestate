  ...
  return (
    <div className="px-[18px] sm:px-[50px] lg:px-[135px] py-[55px] lg:py-[150px] bg-main-purple h-auto  ">
          ...
          <div className='grid grid-cols-2'>
            <span className=' col-span-2 lg:col-span-1 mb-10 lg:mb-0 block sm:text-4xl  text-3xl lg:text-[40px] md:text-center lg:text-left xl:text-[50px] 2xl:text-[54px] text-[#fff] lg:leading-[70px] ' >
          ...
          <div className='flex flex-col md:flex-row  justify-evenly mt-[70px]'>
